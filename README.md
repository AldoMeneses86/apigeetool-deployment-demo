...
- Proxies will be tested with [`AldoMeneses86/newman-test-action`](https://github.com/g-lalevee/newman-test-action)

It can be created from template [`AldoMeneses86/apigeetool-deployment-template`](https://github.com/g-lalevee/apigeetool-deployment-template).
